...
class RedisCluster
{
	 ...
	 */
    public function __construct($name, $seeds ,$timeout = null, $readTimeout = null , $persistent = false) {}
	 ...
	 * @example $redisCluster->setex('key', 3600, 'value'); // sets key → value, with 1h TTL.
	 */
	 ...
	 * @example $redisCluster->psetex('key', 1000, 'value'); // sets key → value, with 1s TTL.
	 */
	...
	/**
	 * Adds values to the set value stored at key.
	 * @param $key
	 * @param array $array
	 *
	 ...
	 */
	public function sAddArray( $key, array $array ) {}
	 ...
	 * $redisCluster->hSetNx('h', 'key1', 'world'); // FALSE, 'key1' => 'hello' in the hash at "h". No change since the field
	 * wasn't replaced.
	 * </pre>
	 */
	 ...
	 * $redisCluster->hmGet('h', array('field1', 'field2')); // returns array('field1' => 'value1', 'field2' => 'value2')
	 * </pre>
	 */
	 ...
	 * echo $redisCluster->ttl('x');                       // 218270121
	 * echo $redisCluster->pttl('x');                      // 218270120575
	 * </pre>
	 */
	 ...
	 * $redisCluster->zAdd('key', 2, 'val2');
	 * $redisCluster->zAdd('key', 10, 'val10');
	 * $redisCluster->zRangeByScore('key', 0, 3);                                          // array('val0', 'val2')
	 * $redisCluster->zRangeByScore('key', 0, 3, array('withscores' => TRUE);              // array('val0' => 0, 'val2' => 2)
	 * $redisCluster->zRangeByScore('key', 0, 3, array('limit' => array(1, 1));                        // array('val2' => 2)
	 * $redisCluster->zRangeByScore('key', 0, 3, array('limit' => array(1, 1));                        // array('val2')
	 * $redisCluster->zRangeByScore('key', 0, 3, array('withscores' => TRUE, 'limit' => array(1, 1));  // array('val2' => 2)
	 * </pre>
	 */
	 ...
	 * a RedisCluster::PIPELINE block is simply transmitted faster to the server, but without any guarantee of atomicity.
	 ...
	 * @param $params String | array [host,port]
	 * @return  bool:   TRUE in case of success, FALSE in case of failure.
	 ...
	 */
	public function bgsave($params) {}

	/**
	 * Removes all entries from the current database at a specific node.
	 * @param $params String key | array [host,port]
	 ...
	 */
	public function flushAll($params) {}
	 ...
	 */
	public function bgrewriteaof($params) {}
	 ...
	 */
	public function lastSave($params) {}
	 ...
	 * @example
	 * <pre>
	 * $redisCluster->role(['127.0.0.1',6379]); // [ 0=>'master',1 => 3129659, 2 => [ ['127.0.0.1','9001','3129242'], ['127.0.0.1','9002','3129543'] ] ]
	 * </pre>
	 */
	 ...
	 * </pre>
	 */
	public function randomKey($params) {}
	...
	/**
	 * Returns message.
	 * @param $nodeParams String key | array [host,port]
	 * @param $msg string
	 ...
	 * @param $latitude
	 * @param $radius float
	 * @param $radiusUnit String can be: "m" for meters; "km" for kilometers , "mi" for miles, or "ft" for feet.
	 * @param array $options
